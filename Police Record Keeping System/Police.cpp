/* Police Record Keeping System using C++ and compiled using GCC Compiler */
...
int login()
{
  ...
  do
  {
    ...
    cout << "\n\n\n\n\n\n";
    cout <<"\t\t\t\t    ----------------------------------\n";
    cout <<"\t\t\t\t      |POLICE RECORD KEEPING SYSTEM|\n";
    cout <<"\t\t\t\t    ----------------------------------\n";
    cout <<"\n\n";
    cout << "\t\t\t\t\t";
    cout << "Username : ";
    ...
    cout << "Password : ";
    cin >> password;
    if(strcmp(username,"dhoni")==0 && password==007)
      {
        cout << "\n\n";
        cout << "\t\t\t\t";
...
void mainpage()
{
  ...
  cout <<"\n\n";
  cout <<"\t\t\t\t";
  cout <<"Under The Guidance of Srimanta Ghosh (Computer Sir)";
  cout <<"\n\n";
  cout <<"\t\t\t\t";
  cout <<"\n\n";
  cout <<"\n\n";
...

{
  ...
  while(c != 1)
  {
    ...
    cin >> (this->conno);
    cout << "\n\n\n\tPLEASE WAIT WHILE OUR SYSTEM CHECKING FOR DUPLICATIONS ";
  ...
  while(!c)
  {
    ...
    if((this->POLICE.date_arrest.y > 2018 )&&(this->POLICE.date_arrest.y<2022))  
      c = 1;
    else
    {
      cout << "\n\t\tINCORRECT INPUT, TRY AGAIN!!\n";
